...
#if defined(NDEBUG)
# error "Blank cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Blank Signed Message:\n";
...
#ifdef ENABLE_WALLET
// Blank: attempt to generate suitable proof-of-stake
