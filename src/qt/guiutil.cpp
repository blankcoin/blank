...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "Blank.lnk";
}
...
{
    return GetAutostartDir() / "Blank.desktop";
}
...
HelpMessageBox::HelpMessageBox(QWidget *parent) :
    QMessageBox(parent)
{
    header = tr("Blank-Qt") + " " + tr("version") + " " +
        QString::fromStdString(FormatFullVersion()) + "\n\n" +
        tr("Usage:") + "\n" +
        "  Blank-qt [" + tr("command-line options") + "]                     " + "\n";
